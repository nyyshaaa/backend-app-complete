...
# webhook simulation
# @direct_uploads_router.post("/upload-callback/{upload_id}")
# async def upload_callback(
#     upload_id: int,
#     payload: dict  # expects {"secure_url": "..."}  
# ):
#     """
#     Simulates the webhook: client or benchmark script calls this
#     immediately after the direct Cloudinary upload returns.
#     """
#     if upload_id not in demo_store:
#         raise HTTPException(404, "Unknown upload_id")
#     demo_store[upload_id] = {
#         "status": "completed",
